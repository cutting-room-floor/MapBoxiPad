...
#define kGettingStartedURL         @"http://mapbox.com/ipad/docs/"
#define kTileStreamHostingPrefix   @"http://api.tiles.mapbox.com"
#define kTileStreamHostingVersion  @"v3"
#define kTileStreamDefaultAccount  @"mapbox"
#define kTileStreamAlbumAPIPath    @"albums.json"
#define kTileStreamTilesetAPIPath  @"tilesets.json"
#define kTileStreamMapAPIPath      @"maps.json"
